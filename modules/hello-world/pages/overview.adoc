...
The Couchbase PHP SDK is a native PHP extension and uses the `Couchbase++` high-performance {cpp} library to handle communicating to the cluster over Couchbase binary protocols.
...
xref:project-docs:migrating-sdk-code-to-3.n.adoc[migration guide] for moving to the 3.3 API.
