...
The Couchbase PHP SDK is a native PHP extension and uses a high-performance {cpp} library to handle communicating to the cluster over Couchbase binary protocols.
