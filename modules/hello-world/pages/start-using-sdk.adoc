...
The API reference is generated for each release and can be found xref:http://docs.couchbase.com/sdk-api/couchbase-php-client-3.0.0/[here].
...
The PHP SDK source code is available on xref:https://github.com/couchbase/php-couchbase[GitHub].
