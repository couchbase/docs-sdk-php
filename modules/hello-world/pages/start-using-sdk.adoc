...
It is a native PHP extension and uses a high-performance {cpp} library to handle communicating to the cluster over Couchbase binary protocols.
...
[source,php]
----
include::devguide:example$php/cloud.php[tag=connect,indent=0]
----
...
[source,php]
----
include::devguide:example$php/start-using.php[tag=connect,indent=0]
----
...
[source,php]
----
include::devguide:example$php/start-using.php[tag=bucket,indent=0]
----

// No waituntilready() in wrappers
...
[source,php]
----
include::devguide:example$php/cloud.php[tag=collection,indent=0]
----
...
[source,php]
----
include::devguide:example$php/cloud.php[tag=upsert-get,indent=0]
----
...
[source,php]
----
include::devguide:example$php/cloud.php[tag=n1ql-query,indent=0]
----
