...
On **Unix-Like** systems (including **macOS**) `libcouchbase` is installed separately as a system library.
...
+
--
On most **Unix-Like** systems you can simply install `libcouchbase` and then use
