...
[source,php]
----
include::devguide:example$cloud.php[tag=connect,indent=0]
----
...
[source,php]
----
include::devguide:example$start-using.php[tag=connect,indent=0]
----
...
[source,php]
----
include::devguide:example$start-using.php[tag=bucket,indent=0]
----
...
[source,php]
----
include::devguide:example$cloud.php[tag=collection,indent=0]
----
...
[source,php]
----
include::devguide:example$cloud.php[tag=upsert-get,indent=0]
----
...
[source,php]
----
include::devguide:example$cloud.php[tag=n1ql-query,indent=0]
----
