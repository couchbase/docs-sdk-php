...
Before you get started you may wish to checkout the xref:{version-server}@server:n1ql:n1ql-language-reference/index.adoc[{sqlpp} intro page], or just dive in with a query against our travel sample data set.
...
Use
xref:{version-server}@server:cli:cbq-tool.adoc[cbq], our interactive Query shell.
...
[source,php]
----
include::devguide:example$php/query.php[tag=positionalParams]
----

.Named parameter example:
[source,php]
----
include::devguide:example$php/query.php[tag=namedParams]
----
...
[source,php]
----
include::devguide:example$php/query.php[tag=results]
----
...
[source,php]
----
include::devguide:example$php/query.php[tag=metrics]
----
...
[source,php]
----
include::devguide:example$php/query.php[tag=scan]
----
...
[source,php]
----
include::devguide:example$php/query.php[tag=consistentWith]
----
////

== Querying at Scope Level

It is possible to query off the xref:{version-server}@server:learn:data/scopes-and-collections.adoc[`Scope` level] _as of Couchbase Server release 7.0 onwards_,
...
[source,php]
----
include::devguide:example$php/query.php[tag=scope-level-query]
----
...
The xref:{version-server}@server:n1ql:n1ql-language-reference/index.adoc[Server doc {sqlpp} intro] introduces up a complete guide to the {sqlpp} language, including all of the latest additions.
