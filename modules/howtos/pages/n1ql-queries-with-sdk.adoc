...
The complete code for this page's examples can be found https://github.com/couchbase/docs-sdk-php/blob/release/3.1/modules/howtos/examples/query.php:[here]
