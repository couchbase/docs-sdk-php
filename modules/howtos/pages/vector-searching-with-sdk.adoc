...
Finally we execute the `SearchRequest` against the Search index "vector-index", which has previously been setup to vector index the "vector_field" field.
...
See the link:++https://docs.couchbase.com/sdk-api/couchbase-php-client/classes/Couchbase-VectorQuery.html#property_prefilter++[API reference].
...
[source,php]
----
include::example$search.php[indent=0,tag=multiplevectorqueries]
----
...
[source,php]
----
include::example$search.php[indent=0,tag=combinedvectorquery]
----
...
* Vector GSI Query is just like any other query from the SDK to the Query service: https://docs.couchbase.com/sdk-api/couchbase-php-client/classes/Couchbase-Scope.html#method_query[PHP SDK API Reference].
...
* Vector Search in the https://docs.couchbase.com/sdk-api/couchbase-php-client/classes/Couchbase-VectorQuery.html[PHP API reference].
