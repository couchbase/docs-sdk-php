...
[source,php]
----
include::devguide:example$php/query.php[indent=0,tag=VectorSearchWithQueryHyperscaleIndex]
----
...
[source,php]
----
include::devguide:example$php/query.php[indent=0,tag=VectorSearchWithQueryParameterized]
----
...
[source,php]
----
include::devguide:example$php/search.php[tag=singlevectorquery]
----
...
[source,php]
----
include::devguide:example$php/search.php[tag=multiplevectorqueries]
----
...
[source,php]
----
include::devguide:example$php/search.php[indent=0,tag=multiplevectorqueries]
----
