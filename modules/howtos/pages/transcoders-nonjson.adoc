...
[source,php]
----
include::devguide:example$php/transcoding.php[tag=encoder,indent=0]
----
...
[source,php]
----
include::devguide:example$php/transcoding.php[tag=decoder,indent=0]
----
...
[source,php]
----
include::devguide:example$php/transcoding.php[tag=usage,indent=0]
----
