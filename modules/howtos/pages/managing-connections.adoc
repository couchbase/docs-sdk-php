...
This is done with the `setting-alternate-address` xref:7.0@server:cli:cbcli/couchbase-cli-setting-alternate-address.adoc[CLI command] introduced in Couchbase Server 6.5.
...
For more on RBAC, refer to the xref:7.0@server:learn:security/authorization-overview.adoc[Server docs].
