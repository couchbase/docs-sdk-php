...
[source,php]
----
include::devguide:example$php/connections.php[tag=rbac]
----
...
[source,php]
----
include::devguide:example$php/managing-connections.php[tag=multiplenodes,indent=0]
----
...
More details can be found in the https://docs.couchbase.com/sdk-api/couchbase-php-client-4.0.0/classes/Couchbase-ClusterOptions.html[API reference].
...
[source,php]
----
include::devguide:example$php/managing-connections.php[tag=customPorts,indent=0]
----
...
[source,php]
----
include::devguide:example$php/managing-connections.php[tag=tls,indent=0]
----
...
[source,php]
----
include::devguide:example$php/managing-connections.php[tag=dnssrv,indent=0]
----
