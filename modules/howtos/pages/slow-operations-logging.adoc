...
[source,php]
----
include::devguide:example$php/threshold-logging.php[tag=logLevel]
----
...
[source,php]
----
include::devguide:example$php/threshold-logging.php[tag=thresholdLogging]
----
...
[source,php]
----
include::devguide:example$php/threshold-logging.php[tag=thresholdLongProcessing]
----
...
[source,php]
----
include::devguide:example$php/orphan-logging.php[tag=orphanLogging]
----
...
[source,php]
----
include::devguide:example$php/orphan-logging.php[tag=orphanTimeout]
----
...
| *tracing_threshold_search*               | duration |     1.0 | Minimum time for the tracing span of Search service to be considered by threshold tracer.
