...
[source,php]
----
include::devguide:example$php/auth.php[tag=auth1,indent=0]
----
...
[source,php]
----
include::devguide:example$php/auth.php[tag=auth2,indent=0]
----
...
[source,php]
----
include::devguide:example$php/auth.php[tag=auth3,indent=0]
----
