...
[source,php]
----
include::devguide:example$php/analytics.php[tag=query]
----
...
[source,php]
----
include::devguide:example$php/analytics.php[tag=simple]
----
...
[source,php]
----
include::devguide:example$php/analytics.php[tag=positional]
----
