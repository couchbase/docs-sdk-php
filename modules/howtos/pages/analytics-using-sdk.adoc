...
This page covers Couchbase's traditional Analytics Service, for long-running queries.
A separate, as-a-service offering -- xref:columnar:intro:intro.adoc[Capella columnar] -- offers real-time analytics.
...
The analytics service is available in xref:cloud:clusters:analytics-service/analytics-service.adoc[Capella operational]
