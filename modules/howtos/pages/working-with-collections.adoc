...
The xref:7.0@server:learn:data/scopes-and-collections.adoc[Collections feature] in Couchbase Server is fully implemented in the 3.2 API versions of the Couchbase SDKs.
...
As well as the xref:hello-world:start-using-sdk.adoc[PHP SDK 3.2] and Couchbase Server,
