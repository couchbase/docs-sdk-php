= Sub-Document Operations with the PHP SDK
...
The _path_ follows N1QL syntax xref:#[below^], and xref:7.1@server:n1ql:n1ql-intro/queriesandresults.adoc[N1QL Queries and Results]).
...
// xattrs
include::7.1@sdk:shared:partial$sdk-xattr-overview.adoc[tag=extended_attributes]
