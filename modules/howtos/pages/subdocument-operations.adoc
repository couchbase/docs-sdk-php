...
The _path_ follows {sqlpp} syntax xref:#[below^], and xref:{version-server}@server:n1ql:n1ql-intro/queriesandresults.adoc[{sqlpp} Queries and Results]).
...
[source,php]
----
include::devguide:example$php/subdoc-lookupin.php[tag=lookupInGet]
----
...
[source,php]
----
include::devguide:example$php/subdoc-lookupin.php[tag=lookupInExists]
----
...
[source,php]
----
include::devguide:example$php/subdoc-lookupin.php[tag=lookupInMulti]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein.php[tag=mutateInUpsert]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein.php[tag=mutateInInsert]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein.php[tag=mutateInMulti]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayAppend]
----

[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayPrepend]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayDoc]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayDocMulti]
----

.Add single array as element to existing array
[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayDocMultiSingle]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayAppendMulti]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayAppendCreatePath]
----
// TODO: SDK will have fluent API to set spec options more verbosely like isXattr(false)->withCreateParents(true)
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein-arrays.php[tag=mutateInArrayInsert]
----
...
[source,php]
----
include::devguide:example$php/subdoc-counters.php[tag=mutateInIncrement]
----
...
[source,php]
----
include::devguide:example$php/subdoc-counters.php[tag=mutateInDecrement]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein.php[tag=mutateInCreatePath]
----
// TODO: php sdk will have fluent APi for subdocument specs
...
[source,php]
----
include::devguide:example$php/subdoc-lookupin.php[tag=lookupinanyreplica]
----
...
[source,php]
----
include::devguide:example$php/subdoc-lookupin.php[tag=lookupinallreplicas]
----
...
For example the following two operations can execute concurrently without any risk of conflict:

[source,php]
----
include::devguide:example$php/subdoc-concurrent.php[tag=mutateInConcurrent]
----
...
[source,php]
----
include::devguide:example$php/subdoc-mutatein.php[tag=mutateInCas]
----
