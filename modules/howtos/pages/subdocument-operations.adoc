...
[source,php]
----
include::example$subdoc-lookupin.php[tag=lookupInGet]
----
...
[source,php]
----
include::example$subdoc-lookupin.php[tag=lookupInExists]
----
...
[source,php]
----
include::example$subdoc-lookupin.php[tag=lookupInMulti]
----
...
[source,php]
----
include::example$subdoc-mutatein.php[tag=mutateInUpsert]
----
...
[source,php]
----
include::example$subdoc-mutatein.php[tag=mutateInInsert]
----
...
[source,php]
----
include::example$subdoc-mutatein.php[tag=mutateInMulti]
----
...
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayAppend]
----

[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayPrepend]
----
...
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayDoc]
----
...
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayDocMulti]
----

.Add single array as element to existing array
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayDocMultiSingle]
----
...
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayAppendMulti]
----
...
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayAppendCreatePath]
----
...
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayAddUnique]
----
...
[source,php]
----
include::example$subdoc-mutatein-arrays.php[tag=mutateInArrayInsert]
----
...
[source,php]
----
include::example$subdoc-counters.php[tag=mutateInIncrement]
----
...
[source,php]
----
include::example$subdoc-counters.php[tag=mutateInDecrement]
----
...
[source,php]
----
include::example$subdoc-mutatein.php[tag=mutateInCreatePath]
----
...
[source,php]
----
include::example$subdoc-lookupin.php[tag=lookupinanyreplica]
----
...
[source,php]
----
include::example$subdoc-lookupin.php[tag=lookupinallreplicas]
----
...
[source,php]
----
include::example$subdoc-concurrent.php[tag=mutateInConcurrent]
----
...
[source,php]
----
include::example$subdoc-mutatein.php[tag=mutateInCas]
----
...
[source,php]
----
include::example$subdoc-mutatein-durability.php[tag=mutateInDurableWrites]
----
