...
[source,php]
----
include::devguide:example$php/provisioning-resources-buckets.php[tag=creating-bucket-mgr,indent=0]
----
...
[source,php]
----
include::devguide:example$php/provisioning-resources-buckets.php[tag=create-bucket,indent=0]
----
...
[source,php]
----
include::devguide:example$php/provisioning-resources-buckets.php[tag=update-bucket,indent=0]
----
...
[source,php]
----
include::devguide:example$php/provisioning-resources-buckets.php[tag=remove-bucket,indent=0]
----
...
[source,php]
----
include::devguide:example$php/provisioning-resources-buckets.php[tag=flush-bucket,indent=0]
----
...
[source,php]
----
include::devguide:example$php/query-index-manager.php[tag=creating-index-mgr,indent=0]
----
...
[source,php]
----
include::devguide:example$php/query-index-manager.php[tag=primary,indent=0]
----
...
[source,php]
----
include::devguide:example$php/query-index-manager.php[tag=secondary,indent=0]
----
...
[source,php]
----
include::devguide:example$php/query-index-manager.php[tag=defer-indexes,indent=0]
----
...
[source,php]
----
include::devguide:example$php/query-index-manager.php[tag=drop-primary-or-secondary-index,indent=0]
----
