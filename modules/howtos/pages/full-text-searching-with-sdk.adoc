...
common query type descriptions.  Couchbase FTS's xref:7.0@server:fts:fts-query-types.adoc[range of query types] enable
...
* More details on Search Queries can be found xref:7.0@server:fts:fts-query-types.adoc[in the Server docs].
