...
include::7.1@sdk:shared:partial$views.adoc[tag=views-intro]
...
////
include::7.1@sdk:shared:partial$views.adoc[tag=example-beer]
...
include::7.1@sdk:shared:partial$views.adoc[tag=example-travel]
...
include::7.1@sdk:shared:partial$views.adoc[tag=example-geo-travel]
