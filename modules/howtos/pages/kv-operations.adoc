...
[source,php]
----
include::example$kv-crud.php[tag=rangescanalldocuments]
----
...
[source,php]
----
include::example$kv-crud.php[tag=rangescanprefix]
----
...
[source,php]
----
include::example$kv-crud.php[tag=rangescansample]
----
...
[source,php]
----
include::example$kv-crud.php[tag=rangescanalldocumentids]
----
