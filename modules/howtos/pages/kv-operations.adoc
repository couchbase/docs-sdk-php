...
Couchbase Data Platform 6.5 refines these two options, with xref:concep-docs:durability.adoc[Synchronous Replication] -- although they remain essentially the same in use.
