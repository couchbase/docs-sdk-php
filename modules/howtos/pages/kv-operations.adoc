...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=insert]
----
...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=replacewithcas]
----
...
IMPORTANT: Preferred Server Group Replica Reads are only accessible with the {name-sdk} working with Couchbase Server 7.6.2 or newer (Capella or self-managed), from SDK version 4.2.6.
...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=get]
----
...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=getwithoptions]
----
...
[source,php]
----
include::devguide:example$php/kv-expiry.php[tag=touch]
----
...
[source,php]
----
include::devguide:example$php/kv-expiry.php[tag=touchwithoptions]
----
...
[source,php]
----
include::devguide:example$php/kv-expiry.php[tag=getandtouch]
----
...
[source,php]
----
include::devguide:example$php/kv-counter.php[tag=increment]
----

[source,php]
----
include::devguide:example$php/kv-counter.php[tag=incrementwithoptions]
----

.Decrement
[source,php]
----
include::devguide:example$php/kv-counter.php[tag=decrement]
----

.Decrement (With Options)
[source,php]
----
include::devguide:example$php/kv-counter.php[tag=decrementwithoptions]
----
...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=rangescanalldocuments]
----

<1> The `RangeScan` class has two optional parameters: `from` and `to`.
...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=rangescanprefix]
----
...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=rangescansample]
----
...
[source,php]
----
include::devguide:example$php/kv-crud.php[tag=rangescanalldocumentids]
----

== Scoped KV Operations

It is possible to perform scoped key value operations on named xref:{version-server}@server:learn:data/scopes-and-collections.adoc[`Collections`] _with the beta version of the next Couchbase Server release, 7.0β_.
