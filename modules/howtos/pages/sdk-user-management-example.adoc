...
[source,php]
----
include::devguide:example$php/provisioning-resources-users.php[tag=create-user,indent=0]
----

.Listing Users
[source,php]
----
include::devguide:example$php/provisioning-resources-users.php[tag=get-all-users,indent=0]
----
...
[source,php]
----
include::devguide:example$php/provisioning-resources-users.php[tag=user-operations,indent=0]
----
