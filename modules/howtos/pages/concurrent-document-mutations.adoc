...
include::7.1@sdk:shared:partial$cas.adoc[tag=intro]

include::7.1@sdk:shared:partial$cas.adoc[tag=demo]

include::7.1@sdk:shared:partial$cas.adoc[tag=example]

include::7.1@sdk:shared:partial$cas.adoc[tag=errors]
...
include::7.1@sdk:shared:partial$cas.adoc[tag=performance]

include::7.1@sdk:shared:partial$cas.adoc[tag=format]

include::7.1@sdk:shared:partial$cas.adoc[tag=locking]
