...
[abstract]
{description}
Using data batching or process forks you can perform effective bulk operations over data.
...
Using a combination of data batching and process forking or the batching API,
you can perform effective bulk operations over data.
...
Batching multiple data operations will improve network utilization efficiency, 
until the point that maximum network efficiency is reached.
For average network conditions, perhaps start with fetching one or two MiB of data.
On a very fast connection between your application server and your Couchbase cluster, try at least 10 MiB.

=== getMulti()

Pass an array of document keys to receive a group of documents.
See the API ref for 
https://docs.couchbase.com/sdk-api/couchbase-php-client/classes/Couchbase-Collection.html#method_getMulti[getMulti] for more information.
...
See the API ref for 
https://docs.couchbase.com/sdk-api/couchbase-php-client/classes/Couchbase-Collection.html#method_upsertMulti[upsertMulti] for more information.
...
Removes a group of documents.
If second element of the entry (CAS) is null, then the operation will remove the document unconditionally.
See the API ref for 
https://docs.couchbase.com/sdk-api/couchbase-php-client/classes/Couchbase-Collection.html#method_removeMulti[removeMulti] for more information.
...
you can find the default locations for other Operating Systems in our https://docs.couchbase.com/server/7.1/cli/cli-intro.html[CLI reference].
