...
Process forks give an improvement in performance -- but at the cost of increased use of CPU, memory, and network traffic.
...
you can find the default locations for other Operating Systems in our xref:https://docs.couchbase.com/server/7.0/cli/cli-intro.html[CLI reference].
