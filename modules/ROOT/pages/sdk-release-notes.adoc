...
* https://issues.couchbase.com/browse/PCBC-574[PCBC-574]: Added documentation on search index manager.
* Updated CouchbaseMock integration. Now the tests could be executed with CouchbaseMock on Windows.
