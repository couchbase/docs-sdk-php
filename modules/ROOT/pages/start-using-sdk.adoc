...
For Ubuntu 18.10, and other Debian based releases unsupported by `couchbase-release-1.0-4-amd64.deb`, either replace the above _first-time setup_ instructions with (here using _cosmic_ for Ubuntu 18.10 Cosmic):
