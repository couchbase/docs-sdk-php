...
For Ubuntu 18.04, and other Debian based releases unsupported by `couchbase-release-1.0-4-amd64.deb`, such as Debian 9, either replace the above first-time stup instructions with
...
or, see the detailed instructions on manually adding repos for your version in the relnotes-c-sdk.adoc#configuring-apt-repositories-debian-ubuntu[C SDK installation instructions].
