...
Once you have PHP installed, then use `PECL` to install the Couchbase PHP SDK (read your PHP distribution manual to find
out where `pecl` is located and whether the user needs special permissions to install new extensions):
