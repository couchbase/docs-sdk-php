...
or, see the detailed instructions on manually adding repos for your version in the xref:relnotes-c-sdk.adoc#configuring-apt-repositories-debian-ubuntu[C SDK installation instructions].
