...
include::4.6@sdk:shared:partial$flush-info-pars.adoc[tag=management-intro]
...
include::4.6@sdk:shared:partial$flush-info-pars.adoc[tag=update-bucket-warning]
...
include::4.6@sdk:shared:partial$flush-info-pars.adoc[tag=index-management]
...
include::4.6@sdk:shared:partial$flush-info-pars.adoc[tag=view-management]
...
include::4.6@sdk:shared:partial$flush-info-pars.adoc[tag=one-view-update-warning]
