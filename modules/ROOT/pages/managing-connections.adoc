...
If using __Docker Swarm__, or otherwise running the SDK inside the NAT, then you will want to disable with `?network = internal` in the connection string, or an xref:client-settings.adoc[environmental setting] can be made.
