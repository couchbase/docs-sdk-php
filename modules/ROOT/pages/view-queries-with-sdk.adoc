...
include::4.6@sdk:shared:partial$views.adoc[tag=views-intro]

include::4.6@sdk:shared:partial$views.adoc[tag=example-travel]

include::4.6@sdk:shared:partial$views.adoc[tag=example-geo-travel]
