...
[#threshold-logging-tracer-ref-php]
|===
...
Follow along with our example of xref:tracing-from-the-sdk.adoc[Tracing from the PHP SDK with Couchbase Server], to discover how to use tracing in the PHP SDK for Response Time Observability.
