...
. SDK 4.x does not expect any system libraries or headers to be installed to work, and uses a statically compiled core implementation
(just like all of the other wrapper SDKs -- those which use the {cpp} SDK at their core -- Node.js, Python, and Ruby).
