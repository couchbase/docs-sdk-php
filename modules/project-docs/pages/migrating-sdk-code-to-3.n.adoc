...
This feature of the SDK API 2 was re-introduced to the PHP SDK in release 3.2.2 -- upgrade to a newer 3.x SDK, and see the API ref for 
...
For 3.1 SDK, see the xref:howtos:concurrent-async-apis.adoc[batching docs] for use of process forks.
