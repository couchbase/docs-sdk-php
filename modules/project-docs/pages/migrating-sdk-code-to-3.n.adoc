...
The current PHP SDK 4.2 is also based on the <<api-version,SDK API 3.5 specification>>, and offers an entirely new backend (Couchbase++) with better support for new features like Distributed ACID Transactions.
...
The primary source of artifacts is xref:sdk-full-installation.adoc[the installation page],
