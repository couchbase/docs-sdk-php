...
|PHP 8.0 VC16 NTS|https://packages.couchbase.com/clients/php/php_couchbase-3.2.0-8.0-nts-x64.zip[php_couchbase-3.2.0-8.0-nts-x64.zip]
|PHP 8.0 VC16 ZTS|https://packages.couchbase.com/clients/php/php_couchbase-3.2.0-8.0-zts-x64.zip[php_couchbase-3.2.0-8.0-zts-x64.zip]
