...
When using Microsoft Windows, instead of using PECL, download a pre-built binary package matching your environment.
...
> Note that, on PHP version 7.2.0 and up, simply using the extension name is preferred.
