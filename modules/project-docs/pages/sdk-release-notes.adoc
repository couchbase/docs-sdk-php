...
* https://issues.couchbase.com/browse/PCBC-788[PCBC-788]: Handle error codes for rate and quota limit conditions
  generated by the server.

* https://issues.couchbase.com/browse/PCBC-796[PCBC-796]: Added storage backend option for bucket manager.

Updated `jsonSerialize` methods to stop deprecations errors in php 8.1.
