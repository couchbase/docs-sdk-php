...
* https://issues.couchbase.com/browse/PCBC-1009[PCBC-1009]:
Do not use `IS_RESOURCE` in function signatures of the extension.

* https://issues.couchbase.com/browse/PCBC-1010[PCBC-1010]:
