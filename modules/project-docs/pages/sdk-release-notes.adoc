...
https://docs.couchbase.com/sdk-api/couchbase-php-client-4.1.6[API documentation] | link:++https://github.com/couchbase/couchbase-php-client/compare/4.1.5...4.1.6++[Full Changelog]
...
Do not allow trailing garbage in encoded CAS value (https://github.com/couchbase/couchbase-php-client/pull/134[#134])

* https://issues.couchbase.com/browse/PCBC-956[PCBC-956]:
Update wrapper side bucket settings. (https://github.com/couchbase/couchbase-php-client/pull/132[#132])

* https://issues.couchbase.com/browse/PCBC-950[PCBC-950]:
Support bucket settings for no dedup feature (https://github.com/couchbase/couchbase-php-client/pull/131[#131])
