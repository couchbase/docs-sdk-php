...
The second part of SDK is written as PHP library and hosted on
https://packagist.org/packages/couchbase/couchbase[packagist.org]. To add it to your project's dependency list, use the
...
* https://issues.couchbase.com/browse/PCBC-707[PCBC-707]:
  Add scope-level query and scope qualifier support for `QueryOptions`.

* https://issues.couchbase.com/browse/PCBC-741[PCBC-741]:
  Fix memory leak in `Bucket::viewQuery()`

* https://issues.couchbase.com/browse/PCBC-734[PCBC-734]:
  Fix destruction of `SearchOptions`.

* https://issues.couchbase.com/browse/PCBC-591[PCBC-591]:
  `KeyNotFoundException` is an alias for `DocumentNotFoundException`
