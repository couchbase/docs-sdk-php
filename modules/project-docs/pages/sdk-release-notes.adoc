...
|===
|Source          |https://packages.couchbase.com/clients/php/couchbase-4.1.1.tgz[couchbase-4.0.1.tgz]
|Checksum        |https://packages.couchbase.com/clients/php/couchbase-4.1.1.sha256sum[couchbase-4.0.1.sha256sum]
|===
