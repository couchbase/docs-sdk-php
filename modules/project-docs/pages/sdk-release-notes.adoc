...
== Version 3.0.3 (June 17, 2020)

API documentation: https://docs.couchbase.com/sdk-api/couchbase-php-client-3.0.3/index.html

* https://issues.couchbase.com/browse/PCBC-696[PCBC-696]: Fix encoding issue in QueryString search query

* https://issues.couchbase.com/browse/PCBC-667[PCBC-667]: Add maxExpiry for CollectionSpec of collection manager

* https://issues.couchbase.com/browse/PCBC-690[PCBC-690]: Increase refcount of arg in ViewOptions::keys()

* https://issues.couchbase.com/browse/PCBC-688[PCBC-688]: Ensure that temporary strings are copied in ViewOptions builder

* https://issues.couchbase.com/browse/PCBC-666[PCBC-666]: Fix invalid memory access of Query result "meta"

* https://issues.couchbase.com/browse/PCBC-665[PCBC-665]: Fix build issue on Debian
