...
* https://issues.couchbase.com/browse/PCBC-746[PCBC-746]:
  Add tests for transcoding empty value

* https://issues.couchbase.com/browse/PCBC-748[PCBC-748]:
  Fix return value of `expiry()` methods for `ReplaceOptions`, `IncrementOptions`, `DecrementOptions` and
  `MutateInOptions` in the documentation stubs.
