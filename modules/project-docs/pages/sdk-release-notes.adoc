...
version 3.0.0 or higher is required for PHP Client 3.0.5.
...
[source,console]
----
$ pecl install https://packages.couchbase.com/clients/php/couchbase-3.0.5.tgz
----
...
|===
|Platform|
|Source          |https://packages.couchbase.com/clients/php/couchbase-3.0.5.tgz[couchbase-3.0.5.tgz]
|Checksum        |https://packages.couchbase.com/clients/php/couchbase-3.0.5.sha256sum[couchbase-3.0.5.sha256sum]
|PHP 7.3 VC15 NTS|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.3-nts-x64.zip[php_couchbase-3.0.5-7.3-nts-x64.zip]
|PHP 7.3 VC15 ZTS|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.3-zts-x64.zip[php_couchbase-3.0.5-7.3-zts-x64.zip]
|PHP 7.4 VC15 NTS|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.4-nts-x64.zip[php_couchbase-3.0.5-7.4-nts-x64.zip]
|PHP 7.4 VC15 ZTS|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.4-zts-x64.zip[php_couchbase-3.0.5-7.4-zts-x64.zip]
|PHP 8.0 VC16 NTS|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-8.0-nts-x64.zip[php_couchbase-3.0.5-8.0-nts-x64.zip]
|PHP 8.0 VC16 ZTS|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-8.0-zts-x64.zip[php_couchbase-3.0.5-8.0-zts-x64.zip]
|PHP 7.3 VC15 NTS (TLS)|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.3-nts-x64-openssl.zip[php_couchbase-3.0.5-7.3-nts-x64-openssl.zip]
|PHP 7.3 VC15 ZTS (TLS)|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.3-zts-x64-openssl.zip[php_couchbase-3.0.5-7.3-zts-x64-openssl.zip]
|PHP 7.4 VC15 NTS (TLS)|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.4-nts-x64-openssl.zip[php_couchbase-3.0.5-7.4-nts-x64-openssl.zip]
|PHP 7.4 VC15 ZTS (TLS)|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-7.4-zts-x64-openssl.zip[php_couchbase-3.0.5-7.4-zts-x64-openssl.zip]
|PHP 8.0 VC16 NTS (TLS)|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-8.0-nts-x64-openssl.zip[php_couchbase-3.0.5-8.0-nts-x64-openssl.zip]
|PHP 8.0 VC16 ZTS (TLS)|https://packages.couchbase.com/clients/php/php_couchbase-3.0.5-8.0-zts-x64-openssl.zip[php_couchbase-3.0.5-8.0-zts-x64-openssl.zip]
|===
...
== Version 3.0.5 (06 December 2020)
...
* https://issues.couchbase.com/browse/PCBC-699[PCBC-699]:
  Add support for minimal durability settings for bucket manager

* https://issues.couchbase.com/browse/PCBC-718[PCBC-718]:
  Deprecate `expiry()` on `GetResult` and `LookupInResult`. `expiry()`   is deprecated in favour to `expiryTime()` which
returns `DateTimeInterface`

* https://issues.couchbase.com/browse/PCBC-715[PCBC-715]:
  refactor document expiry duration

    - allow to specify `DateTimeInterface` objects as expiry value in mutation options

    - when expiration is set as long in seconds, treat the value as relative if it is less than 50 years in seconds. In
      this case take current time and add to the expiration value

* https://issues.couchbase.com/browse/PCBC-733[PCBC-733]:
  Add missing fields for `SearchFacet` results

* https://issues.couchbase.com/browse/PCBC-720[PCBC-720]:
  Allow to disable FTS scoring
