...
Update build scripts and instructions for Windows (https://github.com/couchbase/couchbase-php-client/pull/158[#158], https://github.com/couchbase/couchbase-php-client/pull/164[#164])
* https://issues.couchbase.com/browse/PCBC-984[PCBC-984], https://issues.couchbase.com/browse/PCBC-987[PCBC-987]:
Improve compatiblity with `pcntl_fork()` (https://github.com/couchbase/couchbase-php-client/pull/157[#157], https://github.com/couchbase/couchbase-php-client/pull/162[#162])

==== Fixes

* https://issues.couchbase.com/browse/PCBC-987[PCBC-987]:
Fix consistency vector encoding for FTS (https://github.com/couchbase/couchbase-php-client/pull/163[#163])
...
* https://issues.couchbase.com/browse/CXXCBC-489[CXXCBC-489]: Support scoped eventing functions. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/548[#548], https://github.com/couchbaselabs/couchbase-cxx-client/pull/554[#554])
* https://issues.couchbase.com/browse/CXXCBC-470[CXXCBC-470]: Distinguish between 'unset' and 'off' query_profile (https://github.com/couchbaselabs/couchbase-cxx-client/pull/551[#551])

===== Fixes

* https://issues.couchbase.com/browse/CXXCBC-487[CXXCBC-487]: Check if alternate addressing is used when bootstrapping. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/545[#545])
* https://issues.couchbase.com/browse/CXXCBC-503[CXXCBC-503]: Ignore configuration if it contains an empty vBucketMap. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/556[#556], https://github.com/couchbaselabs/couchbase-cxx-client/pull/558[#558])
* https://issues.couchbase.com/browse/CXXCBC-30[CXXCBC-30]: Inconsistent behaviour when using subdoc opcodes incorrectly (https://github.com/couchbaselabs/couchbase-cxx-client/pull/559[#559])
* https://issues.couchbase.com/browse/CXXCBC-492[CXXCBC-492]: Use retry strategy in collections_component's get_collection_id. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/552[#552])
* https://issues.couchbase.com/browse/CXXCBC-494[CXXCBC-494]: Fix memory issue in range scan implementation. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/549[#549])
...
* https://issues.couchbase.com/browse/CXXCBC-502[CXXCBC-502]: Apply `/bigobj` for SDK objects only. (https://github.com/couchbaselabs/couchbase-cxx-client/pull/550[#550]) Avoid using global add_definitions() as it might leak to non-CXX languages (like `ASM_NASM` on Windows).
