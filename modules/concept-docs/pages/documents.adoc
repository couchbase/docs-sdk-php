...
[source,php,indent=0]
----
include::devguide:example$php/documents-concept.php[tag=mutate-in]
----
...
[source,php,indent=0]
----
include::devguide:example$php/documents-concept.php[tag=lookup-in]
----
...
[source,php,indent=0]
----
include::devguide:example$php/documents-concept.php[tag=counters]
----
...
[source,php,indent=0]
----
include::devguide:example$php/documents-concept.php[tag=counter-increment]
----
