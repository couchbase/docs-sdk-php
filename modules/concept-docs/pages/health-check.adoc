...
include::7.1@sdk:pages:partial$health-check.adoc[tag="intro"]

include::7.1@sdk:pages:partial$health-check.adoc[tag="users"]

include::7.1@sdk:pages:partial$health-check.adoc[tag="ping"]
...
include::7.1@sdk:pages:partial$health-check.adoc[tag="diag"]
