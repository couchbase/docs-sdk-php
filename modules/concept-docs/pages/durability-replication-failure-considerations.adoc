...
WARNING: Client Verified durability is supported in xref:3.2@php-sdk:concept-docs:durability-replication-failure-considerations.adoc#older-server-versions[PHP SDK 3.2] but not in 4.0.
